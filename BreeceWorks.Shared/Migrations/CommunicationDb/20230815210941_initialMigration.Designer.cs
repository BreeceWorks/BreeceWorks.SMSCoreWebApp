...
namespace BreeceWorks.Shared.Migrations.CommunicationDb
{
    ...
    [Migration("20230815210941_initialMigration")]
            ...
            modelBuilder.Entity("BreeceWorks.Shared.Entities.MessageTemplateDto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TemplateId = 1,
                            Name = "WELCOME",
                            TemplateText = "Text messaging for claim @ReferenceId has been activated.  Please reply YES or ACCEPT to continue receiving text messages.  Please reply STOP to opt out of text messaging."
                        },
                        new
                        {
                            TemplateId = 2,
                            Name = "OPTED_OUT_RESPONSE",
                            TemplateText = "You have successfully been unsubscribed. You will not receive any more messages from this number. Reply START to resubscribe."
                        },
                        new
                        {
                            TemplateId = 3,
                            Name = "OPTED_IN_RESPONSE",
                            TemplateText = "You have been subscribed to the text messaging service.  Reply STOP to unsubscribe. Msg&Data Rates May Apply."
                        });
                });
